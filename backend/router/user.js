...
const { CreateUser, activateUser, login, getUser, logout, updateUserInfo, updateUserAvatar, updateUserAddress, deleteUserAddress, updatePassword, getUserInfo } = require('../controller/user');
